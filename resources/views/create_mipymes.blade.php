...
<div class="title"><h2>Datos de los Integrantes</h2></div>
        <div class="row">
            <div class="col-sm-4 col-md-4" title="Número de Identidad">
                <label class="title">
                    Numero Cédula
                </label>
                <div class="input-group ">
            ...
            <div class="col-sm-4 col-md-4">
                ...
                <div class="input-group">
                    <span class="input-group-addon"><i class="fa fa-bed"></i></span>
                    <input placeholder="Primer Apellido Integrantes" type="text" class="form-control" size="14" name="flname" required="required"/>
                </div>
            </div>
            <div class="col-sm-4 col-md-4">
                <label class="title">
                ...
                <div class="input-group">
                    <span class="input-group-addon"><i class="fa fa-address-card"></i></span>
                    <input placeholder="Segundo Apellido Integrantes" type="text" class="form-control" size="14" name="slname" required="required"/>
                </div>
            </div>
